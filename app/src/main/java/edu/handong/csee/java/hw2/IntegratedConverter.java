...
/**
 * Class to convert measurement of one value to the different measurement;;
 * Can convert from KM to Meter, Km to Mile, Mile to Km, Ton to G, Ton to Kg
 */
public class IntegratedConverter {
    ...
    /**
     * Get three args <Value> <Original Measurement> <Convert Measurement> from the user
     */
